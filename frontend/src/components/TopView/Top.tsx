...
const Top = () => {
  ...
  return (
    <div className='relative'>
      <div className='w-screen h-screen bg-no-repeat bg-contain md:bg-cover bg-hero-responsive-img md:bg-hero-img'>        
      </div>
      <div className='md:flex md:w-1/3 md:justify-between absolute md:right-1/3 right-1/4' style={{bottom:'20%'}}>
        {isAuthenticated ?        
